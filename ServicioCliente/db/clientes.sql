...
BEGIN
    ALTER DATABASE BD_CLIENTES SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
...
INSERT CLIENTES(NOM_CLIENTE)
VALUES ('Juan Perez'), ('Maria Quispe');
GO

INSERT CLIENTES_DOCUMENTOS(ID_CLIENTE, ID_TIPO_DOCUMENTO, NUM_DOCUMENTO)
VALUES (1, 1, '12345678'), (2, 2, '20456789123');
GO
